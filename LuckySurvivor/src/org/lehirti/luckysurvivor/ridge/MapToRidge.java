package org.lehirti.luckysurvivor.ridge;
...
public class MapToRidge extends EventNode<NullState> {
  ...
  protected ImgChange updateImageArea() {
    return ImgChange.setBGAndFG(Ridge.RIDGE);
  }
