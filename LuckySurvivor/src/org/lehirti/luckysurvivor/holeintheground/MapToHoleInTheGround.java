package org.lehirti.luckysurvivor.holeintheground;
...
public class MapToHoleInTheGround extends EventNode<NullState> {
  ...
  protected ImgChange updateImageArea() {
    return ImgChange.setBGAndFG(HoleInTheGround.HOLE_IN_THE_GROUND);
  }
  ...
  protected void doEvent() {
    ...
    addOption(Key.OPTION_LEAVE, CommonText.OPTION_LEAVE_AREA, new TextOnlyEvent(Key.OPTION_LEAVE, Text.LEAVE_THE_AREA,
        new Map(Location.HOLE_IN_THE_GROUND)));
  }
}
