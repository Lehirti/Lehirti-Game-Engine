package org.lehirti.luckysurvivor.creekundercliff;
...
public class MapToCreekUnderCliff extends EventNode<NullState> {
  ...
  protected ImgChange updateImageArea() {
    return ImgChange.setBGAndFG(CreekUnderCliff.CREEK_UNDER_CLIFF);
  }
  ...
  protected void doEvent() {
    ...
    addOption(Key.OPTION_LEAVE, CommonText.OPTION_LEAVE_AREA, new TextOnlyEvent(Key.OPTION_LEAVE, Text.LEAVE_THE_AREA,
        new Map(Location.CREEK_UNDER_CLIFF)));
  }
}
