...
public class AreaCrash1_1 extends EventNode<NullState> {
  ...
  protected void doEvent() {
    ...
    addOption(Key.OPTION_NORTH, Text.OPTION_CHECK_PASSENGERS_NEXT_TO_YOU, new TextOnlyEvent(
        Text.CHECK_PASSENGERS_NEXT_TO_YOU, new AreaCrash1_1()));
    addOption(Key.OPTION_WEST, Text.OPTION_LOOK_FOR_YOUR_BAGGAGE, new TextOnlyEvent(Text.LOOK_FOR_YOUR_BAGGAGE,
        new AreaCrash1_1()));
    addOption(Key.OPTION_SOUTH, Text.OPTION_REST_FOR_A_WHILE, new TextOnlyEvent(Text.REST_FOR_A_WHILE, new AreaCrash1_1()));
    addOption(Key.OPTION_EAST, Text.OPTION_CHECK_YOURSELF_FOR_INJURIES, new TextOnlyEvent(
        Text.CHECK_YOURSELF_FOR_INJURIES, new AreaCrash1_1()));
    addOption(Key.OPTION_LEAVE, Text.OPTION_LEAVE_YOUR_SEAT, new TextOnlyEvent(Text.LEAVE_YOUR_SEAT, new AreaCrash1_2()));
  }
}
