...
import intro.IntroImage;
import intro.PlaneInThunderstorm;
import intro.BoardPlane.Text;
...
public class FirstDiscussion extends EventNode<NullState> {
  ...
  protected void doEvent() {
    ...
    addOption(Key.OPTION_Z, Text.OPTION_THE_DEAD, new StandardEvent(Key.OPTION_Z,
