...
public class LogUtils {
  ...
  public static void createDefaultLogConfigFileIfMissing() {
    ...
    if (!logConfigFile.isFile()) {
      ...
      "handlers=java.util.logging.FileHandler, org.lehirti.util.ConsoleHandler\n" + //
          "# Default global logging level.\n" + //
          "# Loggers and Handlers may override this level\n" + //
          ".level=INFO\n" + //
          "org.lehirti.level=FINE\n" + //
          "org.atrun.level=FINE\n" + //
          "org.lehirti.util.ConsoleHandler.formatter=org.lehirti.util.ConsoleLogFormatter\n" + //
          "org.lehirti.util.ConsoleHandler.level=INFO\n" + //
          "# --- FileHandler ---\n" + //
          ...
          "java.util.logging.FileHandler.formatter=org.lehirti.util.LogFileFormatter\n" + //
